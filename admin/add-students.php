...
$sql="insert into tblstudent(StudentName,StudentEmail,StudentClass,Gender,ClubRole,DOB,StuID,FatherName,MotherName,ContactNumber,AltenateNumber,Address,UserName,Password,Image)values(:stuname,:stuemail,:stuclass,:gender,:crole,:dob,:stuid,:fname,:mname,:connum,:altconnum,:address,:uname,:password,:image)";
...
echo "<script>alert('Username or Member Id  already exist. Please try again');</script>";
}
}
  ?>
<!DOCTYPE html>
<html lang="en">
  <head>
    ...
    <title>Student Committee Portal || Add Members</title>
    <!-- plugins:css -->
          ...
          <div class="content-wrapper">
            ...
            <div class="row">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title" style="text-align: center;">Add Members</h4>
                    ...
                    <form class="forms-sample" method="post" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Club</label>
