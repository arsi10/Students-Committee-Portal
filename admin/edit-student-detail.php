...
if (strlen($_SESSION['sturecmsaid']==0)) {
 ...
 $eid=$_GET['editid'];
$sql="update tblstudent set StudentName=:stuname,StudentEmail=:stuemail,StudentClass=:stuclass,Gender=:gender,ClubRole=:crole,DOB=:dob,StuID=:stuid,FatherName=:fname,MotherName=:mname,ContactNumber=:connum,AltenateNumber=:altconnum,Address=:address where ID=:eid";
...
<html lang="en">
  <head>
    ...
    <title>Student Committee Portal || Update Members</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            <div class="page-header">
              <h3 class="page-title"> Update Members </h3>
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  <li class="breadcrumb-item"><a href="dashboard.php">Dashboard</a></li>
                  <li class="breadcrumb-item active" aria-current="page"> Update Members</li>
                </ol>
              </nav>
            </div>
            <div class="row">
...
{               ?>
                      ...
                      <div class="form-group">
                        <label for="exampleInputEmail3">Member Club</label>
                        <select  name="stuclass" class="form-control" required='true'>
                          <option value="<?php  echo htmlentities($row->StudentClass);?>"><?php  echo htmlentities($row->StudentClass);?></option>
                         <?php 
...
<option value="<?php echo htmlentities($row1->ClassName);?>"><?php echo htmlentities($row1->ClassName);?> </option>
 <?php } ?> 
                      ...
                      <div class="form-group">
                        ...
                        <select name="crole" value="" class="form-control" required='true'>
                          <option value="<?php  echo htmlentities($row->ClubRole);?>"><?php  echo htmlentities($row->ClubRole);?></option>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="altconnum" value="<?php  echo htmlentities($row->AltenateNumber);?>" class="form-control" required='false' maxlength="10" pattern="[0-9]+">
                      </div>
                      <div class="form-group">
