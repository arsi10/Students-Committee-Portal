...
?>
                          <span class="report-title">Total Clubs</span>
                          <h4><?php echo htmlentities($totclass);?></h4>
                          <a href="manage-class.php"><span class="report-count"> View Clubs</span></a>
                        </div>
...
?>
                          <span class="report-title">Total Members</span>
                          <h4><?php echo htmlentities($totstu);?></h4>
                          <a href="manage-students.php"><span class="report-count"> View Members</span></a>
                        </div>
...
?>
                          <span class="report-title">Total Club Notice</span>
                          <h4><?php echo htmlentities($totnotice);?></h4>
                          <a href="manage-notice.php"><span class="report-count"> View Club Notices</span></a>
                        </div>
