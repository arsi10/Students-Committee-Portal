...
<html lang="en">
  <head>
    ...
    <title>Student Committee Portal || Search Members</title>
    <!-- plugins:css -->
        ...
        <div class="main-panel">
          <div class="content-wrapper">
             <div class="page-header">
              <h3 class="page-title"> Search Members of Club</h3>
                ...
                <div class="card">
                  <div class="card-body">
                    <form method="post">
                        ...
                        <select id="searchdata" name="searchdata" class="form-control" required='true'>
...
$sdata=$_POST['searchdata'];
  ?>
  <h4>Members of <strong style="color:#0892BE;"><?php echo $sdata;?> Club</strong></h4>
                    </div>
...
$sql="SELECT tblstudent.StuID,tblstudent.ID as sid,tblstudent.StudentName,tblstudent.StudentEmail,tblstudent.ClubRole,tblstudent.StudentClass,tblstudent.ContactNumber,tblstudent.DateofAdmission,tblclass.ClassName from tblstudent join tblclass on tblclass.ID=tblstudent.StudentClass where tblclass.ClassName like '$sdata%' LIMIT $offset, $no_of_records_per_page";
$query = $dbh -> prepare($sql);
$query->execute();
